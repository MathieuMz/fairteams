...
export default function CompetitionApp({ slug, initialData }: Props) {
  ...
  const [rebalanceProposals, setRebalanceProposals] = useState<
  ...
  return (
    <div className="h-screen w-full max-w-4xl mx-auto px-4 pt-6 flex flex-col overflow-x-hidden">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            >
              ...
              {competition.numTeams} équipes · clé: {slug}
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Nav */}
      <div
        className="flex gap-1 p-1 rounded-xl mb-6 flex-nowrap overflow-x-auto flex-shrink-0"
      ...
      >
        {rebalanceProposals !== null ? (
          ...
          <TabConfig competition={competition} onUpdated={handleUpdated} />
        ) : activeTab === "import" ? (
          <TabImport
            slug={slug}
            competition={competition}
      ...
      {rebalanceLoading && (
        <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none">
          <div
            className="rounded-xl px-6 py-4 text-sm font-medium shadow-lg"
            style={surfaceStyle}
          >
